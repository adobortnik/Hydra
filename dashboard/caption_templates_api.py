# Caption Templates API endpoints

from flask import Blueprint, jsonify, request
from simple_app import get_all_caption_templates, get_caption_template, create_caption_template, update_caption_template, delete_caption_template, get_random_captions
